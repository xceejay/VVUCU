...
DROP TABLE IF EXISTS `users`;
 ...
 create table users(id int  not null auto_increment,email varchar(250) not null ,password varchar (200) not null,fname varchar(200) not null,lname varchar(100) not null,
